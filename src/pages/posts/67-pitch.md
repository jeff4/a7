...
title: 'Notes on deck, competition, video'
...
### items on competition
* See this [October 2023 article](https://www.medscape.com/viewarticle/997446?form=fpf) from Medscape. Reference to Rhyme / PriorAuthNow 
* [Axios article](https://www.axios.com/2024/01/18/health-insurance-prior-authorization-doctors) from Justin Jan 2024 'New limits on PA hailed as good first step'.
	* 'In some sense some of this instability might be good / an opportunity, but OTOH it’s just another unhelpful wildcard… And of course if Trump gets elected, who knows what gets reversed and where the pendulum swings. OTOH maybe you could just make the FUD argument that it means docs will just need more help either way.'
